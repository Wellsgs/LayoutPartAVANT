  ...
  ga('send', 'pageview');
    ...
    <header class="navbar navbar-inverse navbar-fixed-top" role="banner">
        ...
        <ul class="nav navbar-nav pull-right toolbar">
        	<li class="dropdown">
        		<a href="#" class="dropdown-toggle username" data-toggle="dropdown"><span class="hidden-xs">John McCartney <i class="icon-caret-down icon-scale"></i></span><img src="assets/demo/avatar/dangerfield.png" alt="Dangerfield" /></a>
    ...
    <div id="page-container">
        ...
        <nav id="page-leftbar" role="navigation">
            ...
            <ul class="acc-menu" id="sidebar">
                ...
                <li><a href="calendar.php"><i class="icon-calendar"></i> <span>Calendar</span></a></li>
                <li><a href="gallery.php"><i class="icon-camera"></i> <span> Gallery</span> </a></li>
...
<script type='text/javascript' src='assets/demo/demo-calendar.js'></script> 
